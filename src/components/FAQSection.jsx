...
const FAQSection = () => {
  return (
    <section className="py-16 text-center">
      <h2 className="text-2xl font-bold mb-8">Vanliga frågor</h2>
      <Accordion type="single" collapsible className="w-full max-w-4xl mx-auto">
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>Ja, TenFAST är byggt för webben. Ingen installation krävs, obegränsat antal användare. Använd din dator eller mobilen!</AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent>Ja, TenFAST är byggt för webben och fungerar på alla enheter.</AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-6">
          ...
          <AccordionContent>För privatpersoner och små företag med upp till 5 hyresobjekt är TenFAST gratis.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-7">
          <AccordionTrigger>Vad räknas som ett hyresobjekt?</AccordionTrigger>
          <AccordionContent>Ett hyresobjekt är en enhet som hyrs ut, till exempel en lägenhet eller ett hus.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-8">
          <AccordionTrigger>Vilka funktioner finns i fastighetsprogrammet?</AccordionTrigger>
          <AccordionContent>TenFAST erbjuder en mängd funktioner inklusive avtalskapare, hyresgäst inloggning, bostadskö, bokföring, statistik, felanmälan, automatiska inbetalningar och öppet API.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-9">
          <AccordionTrigger>Kan jag skapa hyresavtal och signera digitalt?</AccordionTrigger>
          <AccordionContent>Ja, du kan skapa och signera hyresavtal digitalt med BankID eller med penna och papper.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-10">
          <AccordionTrigger>Kan hyresgästen använda det?</AccordionTrigger>
          <AccordionContent>Ja, hyresgästen får inloggningsuppgifter och kan se sina avtal och göra felanmälningar.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-11">
          <AccordionTrigger>Indexering av hyra</AccordionTrigger>
          <AccordionContent>TenFAST erbjuder indexering av hyra baserat på konsumentprisindex.</AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-13">
          ...
          <AccordionContent>Ja, vi erbjuder support via e-post och telefon för att hjälpa dig komma i gång.</AccordionContent>
        </AccordionItem>
      </Accordion>
    </section>
  );
